...
"""Launch an iris quadcopter with lidar in warehouse world."""
...
def generate_launch_description():
    """Generate a launch description for iris quadcopter in warehouse."""
    ...
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument(
                "lidar_dim",
                default_value="3",
                description="Whether to use a 2D or 3D lidar (2 or 3)",
            ),
            gz_sim_server,
            gz_sim_gui,
            iris,
